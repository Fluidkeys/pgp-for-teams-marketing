...
We are much more likely to reach people like Tina than Chat, so it's really her we're focusing on helping. We need to make it really easy for Tina to get Chat using PGP.
